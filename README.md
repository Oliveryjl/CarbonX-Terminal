# 🌿 CarbonX Elite v9.5 | Decentralized Carbon Terminal

[![University](https://img.shields.io/badge/XMUM-Blockchain%20Finance-green)](https://www.xmu.edu.my/)
[![Course Code](https://img.shields.io/badge/Course-G0253-blue)](https://www.xmu.edu.my/)
[![Academic Session](https://img.shields.io/badge/Session-2026%2F02-orange)](https://www.xmu.edu.my/)

> **"Bridging the gap between blockchain theory and environmental finance practice."**

## 📖 Project Overview
CarbonX Elite is an institutional-grade prototype developed as part of the **G0253 Blockchain Finance** course at **Xiamen University Malaysia**. This terminal simulates the full lifecycle of a carbon asset, specifically optimized for the **Malaysia Bursa Carbon Exchange (BCX)**.
...
| :--- | :--- | :--- |
| **Section 4** | Proposed Solution | Description of tokenization and smart contracts |
| **Section 6** | Critical Evaluation | Comparison with traditional CEX and non-blockchain alternatives |
| **Bonus** | Prototype/Demo | Interactive HTML/JS dashboard with real-time feedback |
